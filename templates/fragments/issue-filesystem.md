...
- File: `cp .claude/tasks/artifacts/<slug>/issue.md .claude/issues/<slug>.md` — line 1 is `# <title>`, the rest the body, never retyped. Commit it with the branch's squash, not on `main`.
